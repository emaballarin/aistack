## GPUArray dnn.py (Theano 1.0.4) - Patched by Emanuele Ballarin on 04/05/2019
## for usage with AIStack and cuDNN 7.5.k (k != 0).
## Replaces: .../lib/pythonX.Y/site-packages/theano/gpuarray/dnn.py
...
def version(raises=True):
    ...
    if version.v is None:
        ...
        v = f()
        if v[0] != v[1]:
            warnings.warn("Mixed dnn version. The header is version %s "
