#!/bin/bash
############################################
###  AIStack, v. 3.1.8-001 (25/04/2019)  ###
############################################
#
...
echo ' '
pip install --upgrade --no-deps https://h2o-release.s3.amazonaws.com/h2o/master/4649/Python/h2o-3.25.0.4649-py2.py3-none-any.whl
