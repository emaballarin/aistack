#!/bin/bash
#############################################
###  AIStack, v. 3.11.6-001 (17/06/2019)  ###
#############################################
#
...
echo ' '
pip install --upgrade --no-deps https://h2o-release.s3.amazonaws.com/h2o/master/4704/Python/h2o-3.25.0.4704-py2.py3-none-any.whl
