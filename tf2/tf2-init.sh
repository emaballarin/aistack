...
rm -f "$SELFTF2_CONDA_ENV_PATH/tf2-aistack/bin/gcc-9"
...
rm -f "$SELFTF2_CONDA_ENV_PATH/tf2-aistack/bin/g++-9"
...
rm -f "$SELFTF2_CONDA_ENV_PATH/tf2-aistack/bin/gfortran-9"
...
ln -s "$(which gcc-7)" "$SELFTF2_CONDA_ENV_PATH/tf2-aistack/bin/gcc-9"
...
ln -s "$(which g++-7)" "$SELFTF2_CONDA_ENV_PATH/tf2-aistack/bin/g++-9"
...
ln -s "$(which gfortran-7)" "$SELFTF2_CONDA_ENV_PATH/tf2-aistack/bin/gfortran-9"
